...
import { VALID_FILES } from '../constants/textEditor';

import { clearMarkers } from './markers';
import { readDependenciesFromJson } from './dependencies';
...
export const readFile = (params, textEditor) => {
  ...
  readDependenciesFromJson(JSON.parse(text), { textEditor, store, preferences });
};
